...
@section('content')
	...
	<span class="firm">@if($quotation->user->id == 3) Ejecutivo de cuenta @elseif($quotation->user->id == 12) Director Comercial @elseif($quotation->user->id == 17) Hunter @else Asesor Comercial @endif</span>
